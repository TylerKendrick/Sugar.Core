namespace System.Utilities
{
    public static class Error
    {
        ...
        public static ArgumentNullException NullArgument(string paramName = null, string message = null) => message != null
            ? new ArgumentNullException(paramName)
            : new ArgumentNullException(paramName, message);

        public static ArgumentException Argument(string paramName = null, string message = null) => message != null
