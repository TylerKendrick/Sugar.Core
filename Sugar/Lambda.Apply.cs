namespace System
{
    ...
    public static partial class Lambda
    {
        ...
        public static Action Apply<T1, T2, T3, T4>(
            this Action<T1, T2, T3, T4> action, T1 t1, T2 t2, T3 t3, T4 t4) => () => action(t1, t2, t3, t4);
        ...
        public static Action<T2, T3, T4> ApplyFirst<T1, T2, T3, T4>(
            this Action<T1, T2, T3, T4> action, T1 t1) => (t2, t3, t4) => action(t1, t2, t3, t4);
        ...
        public static Action<T1, T3, T4> ApplySecond<T1, T2, T3, T4>(
            this Action<T1, T2, T3, T4> action, T2 t2) => (t1, t3, t4) => action(t1, t2, t3, t4);
        ...
        public static Action<T1, T2, T4> ApplyThird<T1, T2, T3, T4>(
            this Action<T1, T2, T3, T4> action, T3 t3) => (t1, t2, t4) => action(t1, t2, t3, t4);
        ...
        public static Action<T1, T2, T3> ApplyFourth<T1, T2, T3, T4>(
            this Action<T1, T2, T3, T4> action, T4 t4) => (t1, t2, t3) => action(t1, t2, t3, t4);
        #endregion Apply T4
        ...
        public static Action Apply<T1, T2, T3>(
            this Action<T1, T2, T3> action, T1 t1, T2 t2, T3 t3) => () => action(t1, t2, t3);
        ...
        public static Action<T2, T3> ApplyFirst<T1, T2, T3>(
            this Action<T1, T2, T3> action, T1 t1) => (t2, t3) => action(t1, t2, t3);

        /// <summary>
        /// Returns a <see cref="Action{T1, T3}"/>  that applies the second argument to a <see cref="Action{T1, T2, T3}"/> instance.
        /// </summary>
        public static Action<T1, T3> ApplySecond<T1, T2, T3>(
            this Action<T1, T2, T3> action, T2 t2) => (t1, t3) => action(t1, t2, t3);
        ...
        public static Action<T1, T2> ApplyThird<T1, T2, T3>(
            this Action<T1, T2, T3> action, T3 t3) => (t1, t2) => action(t1, t2, t3);
        ...
        public static Action Apply<T1, T2>(
            this Action<T1, T2> action, T1 t1, T2 t2) => () => action(t1, t2);
        ...
        public static Action<T2> ApplyFirst<T1, T2>(
            this Action<T1, T2> action, T1 t1) => t2 => action(t1, t2);
        ...
        public static Action<T1> ApplySecond<T1, T2>(
            this Action<T1, T2> action, T2 t2) => t1 => action(t1, t2);
        ...
        public static Action Apply<T1>(
            this Action<T1> action, T1 t1) => () => action(t1);
        ...
        public static Func<TResult> Apply<T1, T2, T3, T4, TResult>(
            this Func<T1, T2, T3, T4, TResult> func, T1 t1, T2 t2, T3 t3, T4 t4) => () => func(t1, t2, t3, t4);
        ...
        public static Func<T2, T3, T4, TResult> ApplyFirst<T1, T2, T3, T4, TResult>(
            this Func<T1, T2, T3, T4, TResult> func, T1 t1) => (t2, t3, t4) => func(t1, t2, t3, t4);
        ...
        public static Func<T1, T3, T4, TResult> ApplySecond<T1, T2, T3, T4, TResult>(
            this Func<T1, T2, T3, T4, TResult> func, T2 t2) => (t1, t3, t4) => func(t1, t2, t3, t4);
        ...
        public static Func<T1, T2, T4, TResult> ApplyThird<T1, T2, T3, T4, TResult>(
            this Func<T1, T2, T3, T4, TResult> func, T3 t3) => (t1, t2, t4) => func(t1, t2, t3, t4);
        ...
        public static Func<T1, T2, T3, TResult> ApplyFourth<T1, T2, T3, T4, TResult>(
            this Func<T1, T2, T3, T4, TResult> func, T4 t4) => (t1, t2, t3) => func(t1, t2, t3, t4);
        ...
        public static Func<TResult> Apply<T1, T2, T3, TResult>(
            this Func<T1, T2, T3, TResult> func, T1 t1, T2 t2, T3 t3) => () => func(t1, t2, t3);
        ...
        public static Func<T2, T3, TResult> ApplyFirst<T1, T2, T3, TResult>(
            this Func<T1, T2, T3, TResult> func, T1 t1) => (t2, t3) => func(t1, t2, t3);
        ...
        public static Func<T1, T3, TResult> ApplySecond<T1, T2, T3, TResult>(
            this Func<T1, T2, T3, TResult> func, T2 t2) => (t1, t3) => func(t1, t2, t3);
        ...
        public static Func<T1, T2, TResult> ApplyThird<T1, T2, T3, TResult>(
            this Func<T1, T2, T3, TResult> func, T3 t3) => (t1, t2) => func(t1, t2, t3);
        ...
        public static Func<TResult> Apply<T1, T2, TResult>(
            this Func<T1, T2, TResult> func, T1 t1, T2 t2) => () => func(t1, t2);
        ...
        public static Func<T2, TResult> ApplyFirst<T1, T2, TResult>(
            this Func<T1, T2, TResult> func, T1 t1) => t2 => func(t1, t2);
        ...
        public static Func<T1, TResult> ApplySecond<T1, T2, TResult>(
            this Func<T1, T2, TResult> func, T2 t2) => t1 => func(t1, t2);
        #endregion Apply T2
        ...
        public static Func<TResult> ApplyFirst<T1, TResult>(
            this Func<T1, TResult> func, T1 t1) => () => func(t1);
