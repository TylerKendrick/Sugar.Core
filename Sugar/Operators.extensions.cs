...
namespace System
{
    ...
    public static partial class OperatorsExtensions
    {
        ...
        /// </summary>
        public static Operators.Nullary<TOut> ToNullary<TOut>(this Func<TOut> func) => () => func();
        ...
        public static Operators.Nullary<TResult> ToNullary<TLeft, TRight, TResult>(
            this Operators.Binary<TLeft, TRight, TResult> binaryOperator, TLeft left, TRight right) => () => binaryOperator(left, right);

        /// <summary>
        /// Converts a <see cref="Func{TIn, TOut}"/> to an <see cref="Operators.Unary{TIn, TOut}"/> of the same signature. 
        /// </summary>
        public static Operators.Unary<TIn, TOut> ToUnary<TIn, TOut>(this Func<TIn, TOut> func) => x => func(x);
        ...
        public static Operators.Unary<TRight, TResult> ToUnary<TLeft, TRight, TResult>(
            this Operators.Binary<TLeft, TRight, TResult> binaryOperator, TLeft left) => right => binaryOperator(left, right);
        ...
        public static Operators.Binary<TLeft, TRight, TResult> ToBinary<TLeft, TRight, TResult>(
            this Func<TLeft, TRight, TResult> func) => (left, right) => func(left, right);
    }
}