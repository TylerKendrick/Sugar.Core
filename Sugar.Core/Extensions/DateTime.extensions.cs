namespace System
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// </summary>
        public static bool IsToday(this DateTime self) => self.Date == DateTime.Today.Date;
        ...
        public static bool IsYesterday(this DateTime self)
            => self.Date == DateTime.Today.Date.AddDays(-1);
        ...
        public static bool IsMonthOfYear(this DateTime self, MonthOfYear monthOfYear)
            => self.Month == (int)monthOfYear;

        /// <summary>
        /// Exposes the static method DateTime.IsLeapYear as an extension to <see cref="DateTime"/> instances.
        /// </summary>
        public static bool IsLeapYear(this DateTime self) => DateTime.IsLeapYear(self.Year);
    }
}
