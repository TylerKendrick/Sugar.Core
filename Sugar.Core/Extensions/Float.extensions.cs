namespace System
{
    ...
    public static class FloatExtensions
    {
        ...
        /// </summary>
        public static bool IsPositive(this float self) => self >= 0;

        /// <summary>
        /// Checks to see if the value <paramref name="self"/> is less than zero.
        /// </summary>
        public static bool IsNegative(this float self) => self < 0;

        /// <summary>
        /// Exposes float.IsPositiveInfinity as an extension to <see cref="float"/> instances.
        /// </summary>
        public static bool IsPositiveInfinity(this float self) => float.IsPositiveInfinity(self);

        /// <summary>
        /// Exposes float.IsNegativeInfinity as an extension to <see cref="float"/> instances.
        /// </summary>
        public static bool IsNegativeInfinity(this float self) => float.IsNegativeInfinity(self);

        /// <summary>
        /// Exposes float.IsInfinity as an extension to <see cref="float"/> instances.
        /// </summary>
        public static bool IsInfinity(this float self) => float.IsInfinity(self);

        /// <summary>
        /// Exposes float.IsInfinity as an extension to <see cref="float"/> instances.
        /// </summary>
        public static bool IsNaN(this float self) => float.IsNaN(self);
    }
}
