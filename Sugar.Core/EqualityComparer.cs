namespace System
{
    ...
    public static class EqualityComparer
    {
        ...
        public static IEqualityComparer<T> Create<T>(Func<T, T, bool> equalityComparer)
            => new InternalEqualityComparer<T>(equalityComparer, x => x.GetHashCode());
        ...
        public static IEqualityComparer<T> Create<T>(Func<T, T, bool> equalityComparer,
            Func<T, int> hashGenerator) => new InternalEqualityComparer<T>(equalityComparer, hashGenerator);
        ...
        internal class InternalEqualityComparer<T> : IEqualityComparer<T>
        {
            ...
            public bool Equals(T x, T y) => _equalityComparer(x, y);

            public int GetHashCode(T obj) => _hashGenerator(obj);
        }
    }
}