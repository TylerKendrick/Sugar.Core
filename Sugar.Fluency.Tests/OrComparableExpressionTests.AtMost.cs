...
namespace System.Fluency.Tests
{
    public partial class OrComparableExpressionTests
    {
        ...
        [TestMethod]
        public void AtMostMethodFulfillsExpectationsWhenComparableIsGreaterThanTrueConcern()
        {
            var mockComparable = Register<IFakeConcern>();
            _fakeConcern.Setup(x => x.CompareTo(mockComparable.Object)).Returns(1);

            var result = _trueConcern.AtMost(mockComparable.Object);
        ...
        [TestMethod]
        public void AtMostMethodFulfillsExpectationsWhenComparableIsGreaterThanTrueConcernWithCustomComparer()
        {
            var mockComparable = Register<IFakeConcern>();
            _mockComparer.Setup(x => x.Compare(_fakeConcern.Object, mockComparable.Object))
                .Returns(1);
            var result = _trueConcern.AtMost(mockComparable.Object, _mockComparer.Object);
