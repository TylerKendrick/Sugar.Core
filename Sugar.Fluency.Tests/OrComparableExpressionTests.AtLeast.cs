...
namespace Sugar.Fluency.Tests
{
    public partial class OrComparableExpressionTests
    {
        ...
        [TestMethod]
        public void AtLeastMethodFulfillsExpectationsWhenComparableIsLessThanTrueConcern()
        {
            var mockComparable = Register<IFakeConcern>();
            _fakeConcern.Setup(x => x.CompareTo(mockComparable.Object)).Returns(-1);

            var result = _trueConcern.AtLeast(mockComparable.Object);
        ...
        [TestMethod]
        public void AtLeastMethodFulfillsExpectationsWhenComparableIsLessThanTrueConcernWithCustomComparer()
        {
            var mockComparable = Register<IFakeConcern>();
            _mockComparer.Setup(x => x.Compare(_fakeConcern.Object, mockComparable.Object))
                .Returns(-1);

            var result = _trueConcern.AtLeast(mockComparable.Object, _mockComparer.Object);
