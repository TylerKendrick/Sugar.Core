...
namespace Sugar.Fluency.Tests
{
    public partial class OrComparableExpressionTests
    {
        ...
        [TestMethod]
        public void GreaterThanMethodFulfillsExpectationsWhenComparableIsGreaterThanTrueConcern()
        {
            var mockComparable = Register<IFakeConcern>();
            _fakeConcern.Setup(x => x.CompareTo(mockComparable.Object)).Returns(-1);

            var result = _trueConcern.GreaterThan(mockComparable.Object);
        ...
        [TestMethod]
        public void GreaterThanMethodFulfillsExpectationsWhenComparableIsEqualToTrueConcern()
        {
            var mockComparable = Register<IFakeConcern>();
            _fakeConcern.Setup(x => x.CompareTo(mockComparable.Object)).Returns(0);
        ...
        [TestMethod]
        public void GreaterThanMethodFulfillsExpectationsWhenComparableIsGreaterThanTrueConcernWithCustomComparer()
        {
            var mockComparable = Register<IFakeConcern>();
            _mockComparer.Setup(x => x.Compare(_fakeConcern.Object, mockComparable.Object)).Returns(-1);

            var result = _trueConcern.GreaterThan(mockComparable.Object, _mockComparer.Object);
        ...
        [TestMethod]
        public void GreaterThanMethodFulfillsExpectationsWhenComparableIsEqualToTrueConcernWithCustomComparer()
        {
            var mockComparable = Register<IFakeConcern>();
            _mockComparer.Setup(x => x.Compare(_fakeConcern.Object, mockComparable.Object)).Returns(0);
