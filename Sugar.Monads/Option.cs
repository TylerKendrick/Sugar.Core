        ...
        private static object EvaluateBody<TIn>(TIn context, Expression expression)
        {
            ...
            switch (expression.NodeType)
            {
                ...
                case ExpressionType.Parameter:
                    ...
                    break;
                default:
                    var message = $"Expression type {expression.NodeType} is not supported.";
        ...
        private static object GetMemberValue(object context, MemberInfo memberInfo)
        {
            ...
            switch (memberInfo.MemberType)
            {
                ...
                case MemberTypes.Field:
                    ...
                    break;
                default:
                    var message = $"Expression of type {memberInfo.MemberType} is not supported.  Only Member Access may be used.";
                    throw new NotSupportedException(message);
            }
            return result;
        }
